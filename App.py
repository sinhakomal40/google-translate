...
def translate():
    ...
    def cancel():
        top1.destroy()
    top1.title('Translate')
    top1.configure(bg='white')
    l5 = Label(top1, text="Detect Language", font=("Ubuntu", 16), bg='white', fg=color1)
    l6 = Label(top1, text="Enter Text", font=("Ubuntu", 12), bg='white', fg=color1)
    l7 = Label(top1, text="Select", font=("Ubuntu", 12), bg='white', fg=color1)
    l8 = Label(top1, text="Translation", font=("Ubuntu", 12), bg='white', fg=color1)
...
b3 = Button(top, text="Translate", command=translate, font=("Ubuntu", 11), height=2, width=20, fg='white',
